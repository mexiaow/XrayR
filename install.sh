...
install_XrayR() {
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -q -N --no-check-certificate -O /usr/local/XrayR/XrayR-linux.zip https://github.com/mexiaow/XrayR/releases/download/v1.0/XrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        url="https://github.com/mexiaow/XrayR/releases/download/v1.0/XrayR-linux-${arch}.zip"
...
EOF
    ...
    curl -o /usr/bin/XrayR -Ls https://raw.githubusercontent.com/mexiaow/XrayR/master/XrayR.sh
